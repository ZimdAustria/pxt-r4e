...
const fanfare = ["c4:1", "r:0.5", "g3:1", "g3:1", "a3:2",
    "g3:3", "r0.5", "b3:2", "c4:2"];
...
const superMario = [
    "e4:1", "e4:1", "r:0.5", "e4", "r:0.5",
    "c4:1", "e4:1", "r:0.5", "g4:2", "r:2",
    "g3:2"];
const starWars = [
    "g3:1", "g3:1", "g3:1", "c3:6", "g3:6",
    "f3:1", "e3:1", "d3:1", "c4:6", "g3:4",
    "f3:1", "e3:1", "d3:1", "c4:6", "g3:4",
    "f3:1", "e3:1", "f3:1", "d3:6"];
const beHappy = [
...
const donauwalzer = [
    ...
    "r:0.5", "e4:2.5", "e4:3", "r:0.5", "c#4:2.5",
    "c#4:3", "r:0.5", "a3:2", "a3:2", "c#4:2",
    "e4:2", "e4:2.5", "r:0.5", "e4:2.5", "e4:3",
    "r:0.5", "d4:2.5", "d4:3"];
const rainbow = [
